...
REM set PATH=C:\MinGW\bin;C:\epics\re2c-0.13.5-bin;C:\Strawberry\perl\bin;C:\epics\base-3.15.5\bin\windows-x64;%PATH%
set PATH=C:\MinGW\bin;C:\epics\re2c-0.13.5-bin;C:\Strawberry\perl\bin;C:\epics\epics-base\bin\windows-x64;%PATH%
